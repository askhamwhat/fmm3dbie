...
c
c
      subroutine dtriaints_wnodes_vec(npatches,norder,npols,
     1   srccoefs,ndtarg,ntarg,xyztarg,itargptr,ntargptr,
     2   nporder,nppols,fker,nker,ndd,dpars,ndz,zpars,ndi,ipars,nqpts,
     3   qnodes,wts,cintvals)
c
c
c       this subroutine computes the integral of
...
c
      ...
      implicit none
      integer npatches,norder,npols,ndtarg,nker
      integer nporder,nppols
      real *8 srccoefs(9,npols,npatches),xyztarg(ndtarg,ntarg)
      integer ntarg
      integer itargptr(npatches),ntargptr(npatches)
      ...
      integer i,ipatch,j,lda,ldb,itarg,ldc,ntarg0,ii,l,ncols,ntargmax
...
c
     ...
     1            ndz,zpars,ndi,ipars,xkernvals(1,j,ii))
       ...
       ncols = ntarg0*nker
       call dgemm_guru(transa,transb,nppols,ncols,nqpts,alpha_c,
     1      sigvals,nppols,xkernvals2,nqpts,beta_c,
     2      cint2,nppols)
