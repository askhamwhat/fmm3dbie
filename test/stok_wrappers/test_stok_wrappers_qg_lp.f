...
c 
     ...
     1       srcvals,srccoefs,ifplot,fname)
      ...
      do i=1,npts
         call st3d_slp_vec(i9_8,xyz_out,i3_8,srcvals(1,i),i0_8,
     1        dpars,i0_8,zpars,i0_8,ipars,smat)
         call st3d_strac_vec(i9_8,xyz_out,i12_8,srcvals(1,i),i0_8,dpars,
     ...
     1        + stracmat(3,3)*sigout(3)
      ...
      do i = 1,nin
         call st3d_slp_vec(i9_8,xyz_out,i3_8,xyz_in(1,i),i0_8,dpars,
...
c     
      ...
      do i = 1,npts
         call st3d_slp_vec(i9_8,srcvals(1,i),i3_8,xyz_in,i0_8,dpars,
     1        i0_8,zpars,i0_8,ipars,smat)
         call st3d_dlp_vec(i9_8,srcvals(1,i),i3_8,xyz_in,i0_8,dpars,
